...
public class HighVoltageSwitchDTO implements Serializable {

	private static final long serialVersionUID = -1053508483111408284L;
	
	public HighVoltageSwitchDTO(HighVoltageSwitch s) {
		this.id = s.getId();
		this.address = s.getAddress();
		this.deviceNumber = s.getDeviceNumber();
		this.inlineIndex = s.getInlineIndex();
		this.latitude = s.getLatitude();
		this.lineId = s.getLineId();
		this.longitude = s.getLongitude();
		this.name = s.getName();
		this.showName = s.getShowName();
		this.simNumber = s.getSimNumber();
	}
