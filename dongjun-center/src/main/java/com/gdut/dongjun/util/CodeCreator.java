...
public class CodeCreator {
	...
	private static final String DAO_PATH = "main/java/com/gdut/dongjun/dao";
	private static final String DAO_IMPL_PATH = "main/java/com/gdut/dongjun/dao/impl";
	...
	// 包名
	private static final String BEAN_URL = "com.gdut.dongjun.po";
	private static final String DAO_URL = "com.gdut.dongjun.dao";
	private static final String DAO_IMPL_URL = "com.gdut.dongjun.dao.impl";
	...
	private static final String BASE_DAO_INTERFACE_IMPORT = "import com.gdut.dongjun.dao.SinglePrimaryKeyBaseMapper;";
	private static final String PO_IMPORT = "import com.gdut.dongjun.po.";
	private static final String REPOSITORY_IMPORT = "import org.springframework.stereotype.Repository;";
	private static final String BASE_DAO_IMPLEMENT_IMPORT = "import com.gdut.dongjun.dao.impl.SinglePrimaryKeyBaseDAOImpl;";
	private static final String IMPORT = "import";
	private static final String BASE_SERVICE_INTERFACE_IMPORT = "import com.gdut.dongjun.service.BaseService;";
	private static final String BASE_SERVICE_IMPLEMENT_IMPORT = "import com.gdut.dongjun.service.impl.BaseServiceImpl;";
...
//				+ getLowercaseChar(getLastChar(cName)) + "Dao;" + RT_1 + BLANK_4 + "}" + RT_2 + "}");
	...
	public static void main(String[] args) throws Exception {
		...
		list.add(HighVoltageSwitch.class);
		list.add(Line.class);
		list.add(LowVoltageSwitch.class);
		list.add(Module.class);
		list.add(Substation.class);
		for (Class c : list) {
