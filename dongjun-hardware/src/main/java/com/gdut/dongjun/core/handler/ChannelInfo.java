...
/**
 * 对Channel所对应的信息的抽象
 * 对之前的{@link com.gdut.dongjun.core.SwitchGPRS}功能有所取舍
 * @author Gordan_Deng
 * @date 2017年5月10日
 */
public class ChannelInfo implements Serializable {
	...
	public ChannelInfo(String moduleId, String monitorId, String groupId, String decimalAddress, ChannelHandlerContext ctx) {
		this(ctx);
