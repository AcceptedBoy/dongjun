...
public class AutoCommitSqlSessionTemplate implements SqlSession {
	 ...
	 */
	public AutoCommitSqlSessionTemplate(SqlSessionFactory sqlSessionFactory) {
	 ...
	 * @param executorType
	 */
	public AutoCommitSqlSessionTemplate(SqlSessionFactory sqlSessionFactory, ExecutorType executorType) {
	...
	private class SqlSessionInterceptor implements InvocationHandler {
		public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
			SqlSession sqlSession = getSqlSession(AutoCommitSqlSessionTemplate.this.sqlSessionFactory,
					AutoCommitSqlSessionTemplate.this.executorType,
					AutoCommitSqlSessionTemplate.this.exceptionTranslator);
			try {
				Object result = method.invoke(sqlSession, args);
				if (!isSqlSessionTransactional(sqlSession, AutoCommitSqlSessionTemplate.this.sqlSessionFactory)) {
				...
				if (AutoCommitSqlSessionTemplate.this.exceptionTranslator != null
						&& unwrapped instanceof PersistenceException) {
					// release the connection to avoid a deadlock if the
					// translator is no loaded. See issue #22
					closeSqlSession(sqlSession, AutoCommitSqlSessionTemplate.this.sqlSessionFactory);
					sqlSession = null;
					Throwable translated = AutoCommitSqlSessionTemplate.this.exceptionTranslator
