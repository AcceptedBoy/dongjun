...
/**
 * 替代类{@link com.gdut.dongjun.domain.vo.chart.decorator.SwitchChartDataDecorator}
 * @author Gordan_Deng
 * @date 2017年1月12日
 */
@Deprecated
public class ChartDataAdapter extends SwitchChartData {
	
	public List<SwitchChartData> chartList;

	List<Date> timeList;

	SwitchChartData fullChart;

	public ChartDataAdapter() {
		this.chartList = new ArrayList<SwitchChartData>();
		this.timeList = new ArrayList<Date>();
		this.fullChart = new SwitchChartData();
	}

	public SwitchChartData getChartData() {
