var dj = {
  ...
  _cmp: [],
  // _activeCmp: [],
  // setActiveCmp: function(cmps) {
  //   this._activeCmp.splice(0, this._activeCmp.length);
  //   cmps.forEach(function(data, index) {
  //     for(var i = 0; i<this._cmp.length; i++) {
  //       if(data == this._cmp[i].tag) {
  //         this._activeCmp.push(this._cmp[i]);
  //       }
  //     }
  //   });
  // },
