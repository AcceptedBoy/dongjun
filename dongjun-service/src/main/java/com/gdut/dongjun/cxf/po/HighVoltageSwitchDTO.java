...
public class HighVoltageSwitchDTO implements Serializable {
    ...
    public HighVoltageSwitch getHighVoltageSwitch () {
    	HighVoltageSwitch s = new HighVoltageSwitch();
    	s.setId(this.id);
    	s.setAddress(this.address);
    	s.setDeviceNumber(this.deviceNumber);
    	s.setInlineIndex(this.inlineIndex);
    	s.setLatitude(this.latitude);
    	s.setLineId(this.lineId);
    	s.setLongitude(this.longitude);
    	s.setName(this.name);
    	s.setShowName(this.showName);
    	s.setSimNumber(this.simNumber);
    	return s;
    }
}
