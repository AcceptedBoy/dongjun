...
public class HighVoltageSwitchMessageEngine implements ControlMessageEngine, DataMessageEngine, EventMessageEngine {
	...
	public String generatePreparedCloseSwitchMesg(String address) {
		...
		return util.closeSwitchPre(address, HighCommandControlCode.PRE_CLOSE_SWITCH.toString());
	}
	...
	public String generateCloseSwitchMessage(String address) {
		...
		return util.closeSwitchPre(address, HighCommandControlCode.PRE_CLOSE_SWITCH.toString())
				+ util.closeSwitch(address, HighCommandControlCode.CLOSE_SWITCH.toString());
		/*
	 ...
	 * HighVoltageSwitchMessageEngine().generateOpenSwitchMessage("7700")); }
	 */

	public String generateTotalCallMsg(String address) {
		return util.readVoltageAndCurrent(address, HighCommandControlCode.READ_VOLTAGE_CURRENT.toString());
	}

	public String generatePreparedOpenSwitchMesg(String address) {

		return util.openSwitchPre(address, HighCommandControlCode.PRE_OPEN_SWITCH.toString());
	}
	...
	public String generateOpenSwitchMessage(String address) {
		...
		return util.openSwitchPre(address, HighCommandControlCode.PRE_OPEN_SWITCH.toString())
				+ util.openSwitch(address, HighCommandControlCode.OPEN_SWITCH.toString());
		/*
	...
	public String generateFormalOpenSwitchMessage(String address) {
		return util.openSwitch(address, HighCommandControlCode.OPEN_SWITCH.toString());
	}
}
